...
import 'package:hindustane_ecommerce/model/NewModel/Order/OrderData.dart';
...
import 'package:hindustane_ecommerce/view/account/orders/OrderToShipTrack.dart';
                ...
                Container(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      Text(
                        '${widget.package.order.orderAddress.billingName ?? ""}',
                        style: AppStyles.kFontBlack14w5,
                      ),
                      Text(
                        '${widget.package.order.orderAddress.billingEmail ?? ""}',
                        style: AppStyles.kFontBlack12w4,
                      ),
                      Text(
                        '${widget.package.order.orderAddress.billingPhone ?? ""}',
                        style: AppStyles.kFontBlack12w4,
                      ),
                      Text(
                        "Address".tr +
                            ': ${widget.package.order.orderAddress.billingAddress ?? ""}',
                        style: AppStyles.kFontBlack12w4,
                      ),
                      Text(
                        "State".tr +
                            ': ${widget.package.order.orderAddress.getBillingState.name ?? ""}',
                        style: AppStyles.kFontBlack12w4,
                      ),
                      Text(
                        '${widget.package.order.orderAddress.getBillingCity.name ?? ""}, ${widget.package.order.orderAddress.getBillingCountry.name ?? ""}',
                        style: AppStyles.kFontBlack12w4,
                      ),
                      SizedBox(
                        height: 10,
                      ...
                      //SHIP TO
                      Text(
                        widget.package.order.deliveryType == "home_delivery"
                            ? 'Ship to'.tr
                            : "Collect from".tr,
                        style: AppStyles.kFontGrey12w5,
                      ),
                      Text(
                        '${widget.package.order.orderAddress.shippingName ?? ""}',
                        style: AppStyles.kFontBlack14w5,
                      ),
                      Text(
                        '${widget.package.order.orderAddress.shippingEmail ?? ""}',
                        style: AppStyles.kFontBlack12w4,
                      ),
                      Text(
                        '${widget.package.order.orderAddress.shippingPhone ?? ""}',
                        style: AppStyles.kFontBlack12w4,
                      ),
                      Text(
                        "Address".tr +
                            ': ${widget.package.order.orderAddress.shippingAddress ?? ""}',
                        style: AppStyles.kFontBlack12w4,
                      ),
                      Text(
                        "State".tr +
                            ': ${widget.package.order.orderAddress.getShippingState.name ?? ""}',
                        style: AppStyles.kFontBlack12w4,
                      ),
                      Text(
                        '${widget.package.order.orderAddress.getShippingCity.name ?? ""}, ${widget.package.order.orderAddress.getShippingCountry.name ?? ""}',
                        style: AppStyles.kFontBlack12w4,
                      ),
                    ],
                  ),
