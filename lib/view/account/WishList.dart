...
import 'package:hindustane_ecommerce/model/MyWishListModel.dart';
import 'package:hindustane_ecommerce/model/NewModel/Product/GiftCardData.dart';
        ...
        if (wishListController.isLoading.value) {
          ...
          if (wishListController.wishListModel.value.products == null ||
            ...
            return ListView.builder(
                shrinkWrap: true,
                itemCount: wishListController.wishListModel.value.products.length,
                itemBuilder: (context, index) {
                  List<WishListProduct> value = wishListController.wishListModel.value.products.values.elementAt(index);
                  return Column(
                    children: [
                      Container(
                        color: Colors.white,
                        ...
                        child: Column(
                          children: [
                            _currencyController.vendorType.value == "single"
                                ...
                                : InkWell(
                                    onTap: () {
                                      print('Seller id: ${value[0].seller.id}');
                                      Get.to(() => StoreHome(
                                                  ...
                                                  Container(
                                                    child: Row(
                                                      ...
                                                      children: [
                                                        InkWell(
                                                          onTap: () {
                                                            print('${URLs.API_URL}/wishlist');
                                                            print('product id ::: ${value[prodIndex].id}');
                                                            wishListController
                                                                .deleteWishListProduct(value[index].product.id);
                                                          },
                                                          child: Container(
                                                              height: 30,
                                                              child: SvgPicture
