...
import 'package:hindustane_ecommerce/view/messages/MessageNotifications.dart';
        ...
        if (currencyController.isLoading.value) {
          ...
          return Scaffold(
            body: PersistentTabView(
              ...
              screens: [
                Home(),
                loginController.loggedIn.value ? MessageNotifications() : LoginPage(),
                ...
                PersistentBottomNavBarItem(
                  ...
                  inactiveIcon: Obx(() {
                    return loginController.loggedIn.value
                        ? badges.Badge(
                            // toAnimate: false,
                            // badgeColor: AppStyles.greyColorLight,
                            badgeContent: Text(
                              '${cartController.cartListSelectedCount.value.toString()}',
                              style: AppStyles.appFont.copyWith(
                                color: Colors.white,
