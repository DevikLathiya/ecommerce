...
import 'package:hindustane_ecommerce/controller/my_wishlist_controller.dart';
import 'package:hindustane_ecommerce/controller/product_details_controller.dart';
import 'package:hindustane_ecommerce/model/NewModel/Category/CategoryData.dart';
import 'package:hindustane_ecommerce/model/NewModel/Category/SingleCategory.dart';
import 'package:hindustane_ecommerce/model/NewModel/Product/ProductModel.dart';
import 'package:hindustane_ecommerce/model/NewModel/Product/ProductDetailsModel.dart';
import 'package:hindustane_ecommerce/model/NewModel/Product/ProductType.dart';
import 'package:hindustane_ecommerce/model/NewModel/Product/ProductVariantDetail.dart';
import 'package:hindustane_ecommerce/model/NewModel/Product/Review.dart';
import 'package:hindustane_ecommerce/model/NewModel/Product/SellerSkuModel.dart';
import 'package:hindustane_ecommerce/utils/styles.dart';
import 'package:hindustane_ecommerce/view/MainNavigation.dart';
import 'package:hindustane_ecommerce/view/SearchPageMain.dart';
import 'package:hindustane_ecommerce/view/account/Account.dart';
import 'package:hindustane_ecommerce/view/account/SignInOrRegister.dart';
import 'package:hindustane_ecommerce/view/authentication/LoginPage.dart';
import 'package:hindustane_ecommerce/view/cart/AddToCartWidget.dart';
import 'package:hindustane_ecommerce/view/cart/CartMain.dart';
import 'package:hindustane_ecommerce/view/products/RecommendedProductLoadMore.dart';
import 'package:hindustane_ecommerce/view/products/tags/ProductsByTags.dart';
import 'package:hindustane_ecommerce/view/seller/StoreHome.dart';
import 'package:hindustane_ecommerce/widgets/BuildIndicatorBuilder.dart';
import 'package:hindustane_ecommerce/widgets/CustomDate.dart';
import 'package:hindustane_ecommerce/widgets/GridViewProductWidget.dart';
import 'package:hindustane_ecommerce/widgets/HorizontalProductWidget.dart';
import 'package:hindustane_ecommerce/widgets/SliverAppBarTitleWidget.dart';
import 'package:hindustane_ecommerce/widgets/StarCounterWidget.dart';
import 'package:hindustane_ecommerce/widgets/custom_clipper.dart';
import 'package:hindustane_ecommerce/widgets/custom_loading_widget.dart';
import 'package:hindustane_ecommerce/widgets/flutter_swiper/flutter_swiper.dart';
...
import 'package:hindustane_ecommerce/view/products/RatingsAndReviews.dart';
  ...
  String getDiscountType(ProductModel productModel) {
    ...
    if (productModel.hasDeal != null) {
      if (productModel.hasDeal.discountType == 0) {
        ...
        discountType =
            '(-${(productModel.hasDeal.discount * currencyController.conversionRate.value).toStringAsFixed(2)}${currencyController.appCurrency.value})';
      }
    } else {
      if (productModel.discount > 0) {
        if (productModel.discountType == '0') {
          ...
          discountType =
              '(-${(productModel.discount * currencyController.conversionRate.value).toStringAsFixed(2)}${currencyController.appCurrency.value})';
        }
      } else {
        discountType = '';
      }
  ...
  double getPriceForCart() {
    return double.parse((_productDetailsModel.data.hasDeal != null
            ? _productDetailsModel.data.hasDeal.discount > 0
                ? currencyController.calculatePrice(_productDetailsModel.data)
                : currencyController.calculatePrice(_productDetailsModel.data)
            : currencyController.calculatePrice(_productDetailsModel.data))
        .toString());
  }
