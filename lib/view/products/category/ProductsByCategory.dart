...
import 'package:hindustane_ecommerce/model/SortingModel.dart';
import 'package:hindustane_ecommerce/utils/styles.dart';
import 'package:hindustane_ecommerce/view/SearchPageMain.dart';

import 'package:hindustane_ecommerce/view/products/category/CategoryFilterDrawer.dart';
                              ...
                              return Container(
                                ...
                                child: Wrap(
                                  ...
                                  children: List.generate(
                                      controller.catAllData.value.brands.length,
                                      (index) {
                                    BrandData brand = controller
                                        .catAllData.value.brands[index];
                                    return InkWell(
                                      onTap: () {
                                        setState(() {
                                          filterSelected = true;
