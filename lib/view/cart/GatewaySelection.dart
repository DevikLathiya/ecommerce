...
import 'package:hindustane_ecommerce/AppConfig/api_keys.dart';
import 'package:hindustane_ecommerce/controller/account_controller.dart';
...
import 'package:hindustane_ecommerce/controller/otp_controller.dart';
import 'package:hindustane_ecommerce/controller/settings_controller.dart';
import 'package:hindustane_ecommerce/controller/payment_gateway_controller.dart';
import 'package:hindustane_ecommerce/model/NewModel/GpayTokenModel.dart';
import 'package:hindustane_ecommerce/model/PaymentGatewayModel.dart';
import 'package:hindustane_ecommerce/utils/styles.dart';
import 'package:hindustane_ecommerce/view/authentication/OtpVerificationPage.dart';
import 'package:hindustane_ecommerce/view/payment/bank_payment_sheet.dart';
import 'package:hindustane_ecommerce/view/payment/instamojo_payment.dart';
import 'package:hindustane_ecommerce/view/payment/jazzcash.dart';
import 'package:hindustane_ecommerce/view/payment/midtrans_payment.dart';
import 'package:hindustane_ecommerce/view/payment/paypal/paypal_payment.dart';
import 'package:hindustane_ecommerce/view/payment/paytm_service.dart';
import 'package:hindustane_ecommerce/view/payment/razorpay_sheet.dart';
import 'package:hindustane_ecommerce/view/payment/stripe/stripe_payment.dart';
import 'package:hindustane_ecommerce/view/payment/gpay_service.dart';
  ...
  Future orderConfirmSubmit() async {
    ...
    if (controller.selectedGateway.value.id == 1) {
      ...
      if (_settingsController.otpOnOrderWithCod.value) {
        int cancelOrders =
            _accountController.customerData.value.cancelOrderCount;
      ...
      Get.bottomSheet(
        StripePaymentScreen(
          ...
          onFinish: (onFinish) async {
            ...
            payment.addAll({'transection_id': '${onFinish['id']}'});

            log(payment.toString());

            await controller.paymentInfoStore(
                paymentData: payment, transactionID: onFinish['id']);
          },
        ),
    ...
    ///PayTM
      ...
      await PayTmService().payTmPayment(
          trxData: payment, orderData: _checkoutController.orderData);
    }
      ...
      try {
        ...
        Flutterwave flutterwave = Flutterwave(
          ...
          customer: Customer(
              ...
              email: _checkoutController.orderData['customer_email']),
          txRef: 'AMZ_${DateFormat("yyyyMMddHHmmss").format(DateTime.now())}',
          isTestMode: false,
        );
