...
import 'package:hindustane_ecommerce/widgets/custom_dialog_widget.dart';
import 'package:hindustane_ecommerce/widgets/custom_loading_widget.dart';
import 'package:fancy_shimmer_image/fancy_shimmer_image.dart';
import 'package:flutter/material.dart';
import 'package:get/get.dart';
import 'package:hindustane_ecommerce/view/cart/CartCheckout.dart';
                                                                  ...
                                                                  Expanded(
                                                                    child: Text(
                                                                      currencyController
                                                                              .appCurrency
                                                                              .value +
                                                                          (cartItems[prodIndex].totalPrice * currencyController.conversionRate.value)
                                                                              .toStringAsFixed(2),
                                                                      style: AppStyles
                                                                          .kFontPink15w5,
                                                                    ),
                      ...
                      Text(
                          currencyController.vendorType.value == "single"
                              ? currencyController
                                      ...
                                      null
                                  ? "Free from".tr +
                                      " ${double.parse((currencyController.settingsModel.value.freeShipping.minimumShopping * currencyController.conversionRate.value).toString()).toStringAsFixed(2)}${currencyController.appCurrency.value}"
