...
import 'package:hindustane_ecommerce/model/NewModel/CityList.dart';
import 'package:hindustane_ecommerce/model/NewModel/CountryList.dart';
import 'package:hindustane_ecommerce/model/StateList.dart';
import 'package:hindustane_ecommerce/utils/styles.dart';
import 'package:hindustane_ecommerce/view/settings/widget/location_dropdown_tile.dart';
import 'package:hindustane_ecommerce/widgets/AppBarWidget.dart';
import 'package:hindustane_ecommerce/widgets/ButtonWidget.dart';
...
class _AddAddressState extends State<AddAddress> {
  ...
  _buildDropDown() async {
    try {
      ...
      if (allCountryNew.countries.isNotEmpty) {
      ...
      if (allStatesNew.states.isNotEmpty) {
                    ...
                    children: [
                      ...
                      LocationDropDownTile(
                        ...
                        onTap: () {
                          Get.bottomSheet(
                            ListView.builder(
                              itemCount: allCitiesNew.cities.length,
                              padding: EdgeInsets.zero,
                              itemBuilder: (context, index) {
  ...
  //           setState(() {
  //             selectedCityId =
  //                 allCitiesNew != null ? allCitiesNew.cities[0].id : 0;
  //             selectedCityName =
  //                 allCitiesNew != null ? allCitiesNew.cities[0].name : "None";
  //           });
  //         } catch (e, t) {
  //           debugPrint('come to here ---> some error!!!! 54');
  //           debugPrint(e.toString());
  //           debugPrint(t.toString());
  //         }
  //       },
  ...
  //                 selectedCityId =
  //                     allCitiesNew != null ? allCitiesNew.cities[0].id : 0;
  //                 selectedCityName = allCitiesNew != null
  //                     ? allCitiesNew.cities[0].name
  //                     : 'not found';
  //               });
  //               debugPrint(
  ...
  //             } catch (e, t) {
  //               debugPrint('come to here ---> some error!!!! 458');
  //               debugPrint(e.toString());
  //               debugPrint(t.toString());
  //             }
  //           },
  ...
  //           !loadingAllCities &&
  //           allCitiesNew != null &&
  //           allCitiesNew.cities != null &&
  //           allCitiesNew.cities.isNotEmpty)
  //         getCitiesDropDown(allCitiesNew.cities)
  //       else
  //         Text('No City found'.tr),
  //     ],
  //   );
  // }
  ...
  void _selectCity({int cityCode, String cityName}) {
