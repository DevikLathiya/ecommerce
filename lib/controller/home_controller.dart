...
import 'package:hindustane_ecommerce/model/NewModel/AllRecommendedModel.dart';
import 'package:hindustane_ecommerce/model/NewModel/FilterFromCatModel.dart';
import 'package:hindustane_ecommerce/model/NewModel/FlashDeals/FlashDealData.dart';
import 'package:hindustane_ecommerce/model/NewModel/FlashDeals/FlashDealDataElement.dart';
import 'package:hindustane_ecommerce/model/NewModel/FlashDeals/FlashDealModel.dart';
import 'package:hindustane_ecommerce/model/NewModel/Brand/BrandData.dart';
import 'package:hindustane_ecommerce/model/NewModel/Brand/SingleBrandModel.dart';
import 'package:hindustane_ecommerce/model/NewModel/Category/CategoryData.dart';
import 'package:hindustane_ecommerce/model/NewModel/Category/ParentCategory.dart';
import 'package:hindustane_ecommerce/model/NewModel/Category/SingleCategory.dart';
import 'package:hindustane_ecommerce/model/NewModel/Filter/FilterAttributeValue.dart';
import 'package:hindustane_ecommerce/model/NewModel/Filter/FilterColor.dart';
import 'package:hindustane_ecommerce/model/NewModel/HomePage/HomePageModel.dart';
import 'package:hindustane_ecommerce/model/NewModel/Product/AllProducts.dart';
import 'package:hindustane_ecommerce/model/NewModel/Product/ProductModel.dart';
import 'package:hindustane_ecommerce/model/NewUserZoneModel.dart' as NewUser;
import 'package:hindustane_ecommerce/model/SliderModel.dart';
import 'package:dio/dio.dart';
import 'package:flutter/material.dart';
import 'package:get/get.dart';
import 'package:http/http.dart' as http;

import 'package:hindustane_ecommerce/model/NewModel/Category/CategoryMain.dart';
import 'package:hindustane_ecommerce/model/NewModel/Brand/BrandsMain.dart';
...
class HomeController extends GetxController {
  ...
  ///Brand vars
  // ignore: deprecated_member_use
  var allBrands = List<BrandData>().obs;
  ...
  // ignore: deprecated_member_use
  var allSliders = List<SliderData>().obs;

  ///Flash Deals
  var isFlashDealsLoading = false.obs;

  // ignore: deprecated_member_use
  var flashDealData = List<FlashDealDataElement>().obs;

  // ignore: deprecated_member_use
  var flashProductData = List<FlashDealDataElement>().obs;
  ...
  Future<void> getAllCategory() async {
    try {
      ...
      await _dio
        ...
        allCategory.value =
            dat.data.where((element) => element.parentId == 0).take(7).toList();
  ...
  Future<void> getAllSlider() async {
    try {
      ...
      await _dio
        ...
        allSliders.value = value.sliderData.take(8).toList();
      });
    } catch (e) {
    ...
    try {
      ...
      await http.get(Uri.parse(URLs.FLASH_DEALS)).then((value) {
        ...
        if (value is FlashDealModel) {
          flashDealData.value =
              value.flashDeal.allProducts.data.take(10).toList();
