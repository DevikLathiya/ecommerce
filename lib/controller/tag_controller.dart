...
import 'package:hindustane_ecommerce/model/NewModel/Tags/TagProductsModel.dart';
...
class TagController extends GetxController {
  ...
  Future<TagProductsModel> getTagProducts(tagId) async {
    print('TAG NAME $tagId -> URL : ${URLs.SINGLE_TAG_PRODUCTS + '/$tagId'}');
    try {
      isTagLoading(true);
      await _dio.get(URLs.SINGLE_TAG_PRODUCTS + '/$tagId').then((value) {
        print('TAG Query: ${value.realUri}');
